...
process STAR_GENOMEGENERATE {
    ...
    if (args.contains('--genomeSAindexNbases')) {
        ...
        // /home/zhaorui/anaconda3/envs/rnaseq/bin/samtools faidx $fasta
        // NUM_BASES=`/home/zhaorui/anaconda3/envs/rnaseq/bin/gawk '{sum = sum + \$2}END{if ((log(sum)/log(2))/2 - 1 > 14) {printf "%.0f", 14} else {printf "%.0f", (log(sum)/log(2))/2 - 1}}' ${fasta}.fai`
        """
